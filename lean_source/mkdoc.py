...
rst_path = rst_chapter_path/(section_name + '.rst')
...
# Regular expressions.
main_mode = regex.compile(r'-- MAIN:.*')
both_mode = regex.compile(r'-- BOTH:.*')
solutions_mode = regex.compile(r'-- SOLUTIONS:.*')
omit_mode = regex.compile(r'-- OMIT:.*')
