...
The next one is the theory of filters, which then allows to develop
topological spaces, metric spaces and a slightly more exotic
intermediate notion called a uniform space.

This chapter will contain quite a bit more mathematical explanations
...
Then the behavior of ``f x`` could also be anyone of those 13
...
those 2197 lemmas and let the others as exercises for the reader.
